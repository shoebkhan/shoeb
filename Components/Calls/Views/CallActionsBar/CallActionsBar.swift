...
class CallActionsBar: UIToolbar {
    ...
    private func createButton(withType tag: ActionType) -> ActionButton {
        ...
        switch tag {
        case .audio:
            button.selectedTitle = "Unmute".localized
            button.unSelectedTitle = "Mute".localized
            button.pushed = true
            button.tag = tag.rawValue
            button.iconView = iconView(withNormalImage: "mute_on_ic", selectedImage: "mic_off")
        case .video:
            button.selectedTitle = "Cam on".localized
            button.unSelectedTitle = "Cam off".localized
            button.pushed = true
            button.tag = tag.rawValue
            button.iconView = iconView(withNormalImage: "camera_on_ic", selectedImage: "cam_off")
        case .speaker:
            button.selectedTitle = "Mic".localized
            button.unSelectedTitle = "Speaker".localized
            button.pushed = true
            button.tag = tag.rawValue
            button.iconView = iconView(withNormalImage: "speaker", selectedImage: "speaker_off")
        case .decline:
            button.selectedTitle = "End call".localized
            button.unSelectedTitle = "End call".localized
            button.pushed = true
            button.tag = tag.rawValue
            button.iconView = iconView(withNormalImage: "decline-ic", selectedImage: "decline-ic")
        case .share:
            button.selectedTitle = "Stop sharing".localized
            button.unSelectedTitle = "Screen share".localized
            button.iconView = iconView(withNormalImage: "screensharing_ic", selectedImage: "screenshare_selected")
            button.tag = tag.rawValue
        case .switchCamera:
            button.selectedTitle = "Swap cam".localized
            button.unSelectedTitle = "Swap cam".localized
            button.pushed = true
            button.tag = tag.rawValue
